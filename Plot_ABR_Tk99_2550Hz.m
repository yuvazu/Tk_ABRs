% Plot_ABR_Tk99_2550Hz
% this mfiles plots the ABR Response for Gecko Tk 99 at the
% Frequency of Stimulation = 2550 Hz, before and after performing a surgery exposing the hearing organ.  
...
print=0; % set to 1 if you want to save/store as svg
scaleON=1; % set to 1 if you want to add a time & voltage scale bar, the position is suboptimal which means you will need to edit it in Illustrator

%% set Data Path to ABR Data 
...
if print==1
    fname1 = 'ABR_tk99_2550Hz_Normal_n_Surgery_scale'
    saveas(gcf, fname1)
